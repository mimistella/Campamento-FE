...
const basePath = '/campista';

const menuItems = [
	{ label: 'Perfil', path: 'perfil' },
	{ label: 'Campamento', path: 'campamento' },
	...
	return (
		<>
			...
			<div className="md:hidden flex items-center justify-between p-4 bg-white border-b border-gray-200">
				...
				<button onClick={toggleSidebar} aria-label={isOpen ? "Cerrar menú" : "Abrir menú"} className="text-2xl text-gray-700">
					{isOpen ? <HiX /> : <HiMenu />}
				</button>
			</div>
...
>
				<h2 className="text-xl font-bold text-amber-700 mb-6 hidden md:block">Campista</h2>
