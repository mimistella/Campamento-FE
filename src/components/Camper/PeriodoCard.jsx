            ...
            {isExpanded && (
              <div className="mt-2 text-gray-600 text-sm space-y-1">
                ...
                <p>
                  ...
                  {new Date(periodo.fechaInicioInsc).toLocaleDateString("es-AR")}
                </p>
                <p>
                  <strong>Fin inscripción:</strong>{" "}
                  {new Date(periodo.fechaFinInsc).toLocaleDateString("es-AR")}
                </p>
                <p>
                  <strong>Inicio del campamento:</strong>{" "}
                  {new Date(periodo.fechaInicioPer).toLocaleDateString("es-AR")}
                </p>
              </div>
            )}
          </div>
