    ...
    >
      ...
      <div className="flex justify-between items-start">
        <div className="flex-1">
          ...
          {/* Tag de estado si está inactiva */}
          {cabania.cabinStatus === "Inactivo" && (
            <span className="inline-block bg-orange-100 text-orange-900 text-xs font-semibold px-3 py-1 rounded-full shadow-sm">
              Desactivada
            </span>
          )}
          ...
          {isExpanded && (
            <div className="mt-3 space-y-2">
              <div className="text-sm text-gray-500 space-y-1">
                <p>
                  <strong>Capacidad:</strong> {cabania.capacidad}
                </p>
                <p>
                  <strong>Ubicación:</strong> {cabania.ubicacion}
                </p>
                <p>
                  <strong>Ocupación actual:</strong> {getOcupacion(cabania.id)}
                </p>
                {cabania.deidad && (
                  <p>
                    <strong>Deidad:</strong> {cabania.deidad.nombre}
                  </p>
                )}
              </div>
            </div>
